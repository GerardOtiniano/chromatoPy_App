...
def assign_indices(df_path=None):
    """
    ...
    return {
        "input_path": df_path,
        "indices_path": os.path.join(directory_path, "chromatopy_indices.csv"),
        "fractional_abundance_path": os.path.join(directory_path, "chromatopy_fractional_abundance.csv"),
        "meth_set_path": os.path.join(directory_path, "chromatopy_meth_set.csv"),
        "cyc_set_path": os.path.join(directory_path, "chromatopy_cyc_set.csv"),
    }
