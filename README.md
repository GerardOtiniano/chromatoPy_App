...
chromatoPy now includes a desktop wrapper for the existing workflows.

```bash
python app.py
```

If you use Poetry, you can also launch it with:

```bash
poetry run chromatopy-desktop
```

To package the desktop app with PyInstaller:
